...
public class MessageStore {
    ...
    public static class StoredMessage {
        ...
        public StoredMessage(String topic, String body, String status) {
            this.topic = topic;
            this.body = body;
            this.status = status;
        }
    ...
    public void encode(String topic, String body, String properties) {
    ...
    public void appendMessage(String topic, String body, String properties) {
        encode(topic, body, properties);
        ...
        consumeQueueStore.appendMessage(topic, msgLength, currentPos, tagCode);
    }
    ...
    public StoredMessage getMessage(int pos, int size) {
        ...
        return new StoredMessage(new String(topicData), new String(bodyData), "FOUND");
    }
    ...
    public StoredMessage consumeMessage(String topic, long pullFromThisOffset, String tag) {
        ...
        if (null != tag && !tag.isEmpty()) {
            ...
            if (metadata.getTagCode() != tag.hashCode()) {
                return new StoredMessage(topic, "", "NO_MATCHED_MESSAGE");
            }
        }
        return getMessage(metadata.getPosition(), metadata.getSize());
    }
